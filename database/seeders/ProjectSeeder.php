...
class ProjectSeeder extends Seeder
{
    ...
    private function projectData(): array
    {
        return [
            [
                'slug' => 'project-lawnwriter',
                'title' => 'LawnWriter',
                'byline' => 'Design something to mow into your yard, then get turn-by-turn GPS navigation while you mow it.',
                'description' => '<p>LawnWriter is my own product, built end to end under Russell I/O. You draw the boundary of a property on satellite imagery, design text and shapes to cut into it, and the app turns that design into a mowing route you follow with real-time GPS navigation — telling you where to drive and when to raise or drop the blade.<br><br>The mobile app is React Native on Expo with TypeScript, Zustand for state, React Navigation, Skia for design rendering, and Google Maps for satellite imagery and boundary drawing. The backend is Laravel 12 on PHP 8.4 with Sanctum-authenticated APIs covering properties, designs, mower profiles, and mowing sessions.<br><br>The interesting engineering is in the middle: converting an arbitrary polygon plus a vector design into a physically mowable route. That means Haversine distance math, waypoint generation constrained by the mower\'s actual deck width and turning radius, and a navigation loop that fuses raw GPS with path snapping and turn detection so the guidance stays stable when the signal drifts under trees.<br><br>Everything around it is mine too — Google and Apple sign-in, RevenueCat subscriptions, Sentry monitoring, Jest and Maestro test suites, and the EAS build and App Store Connect pipeline. The app is in pre-production hardening ahead of its App Store launch.</p>',
                'primary_image_src' => 'lawnwriter/icon-card.webp',
                'primary_image_title' => 'LawnWriter',
                'primary_image_alt' => 'LawnWriter app icon',
                'bg_image' => 'lawnwriter/icon-card.webp',
                'bg_position_x' => '0',
                'bg_position_y' => '0',
                'company' => 'Russell I/O, LLC',
                'order' => 0,
                'key_takeaways' => [
                    'Solo-built product: React Native (Expo) mobile app on a Laravel 12 API',
                    'Route engine converts a drawn design into a mowable path using Haversine math and deck-width-aware waypoints',
                    'Real-time GPS navigation with path snapping, turn detection, and blade engagement cues',
                    'Full release pipeline: EAS builds, RevenueCat subscriptions, Sentry monitoring, App Store Connect',
                ],
                'images' => [
                    ['src' => 'lawnwriter/home.webp', 'title' => 'Home', 'alt' => 'LawnWriter home screen showing GPS status, weather, and recent activity'],
                    ['src' => 'lawnwriter/select-property.webp', 'title' => 'Select Property', 'alt' => 'Satellite view of a property before drawing its boundary'],
                    ['src' => 'lawnwriter/draw-boundary.webp', 'title' => 'Draw Property Boundary', 'alt' => 'Drawing a property boundary with live point count and area'],
                    ['src' => 'lawnwriter/add-property.webp', 'title' => 'Add Property', 'alt' => 'Adding a property by current location or address search'],
                    ['src' => 'lawnwriter/my-properties.webp', 'title' => 'My Properties', 'alt' => 'Saved properties with their associated designs'],
                    ['src' => 'lawnwriter/design-editor.webp', 'title' => 'Design Editor', 'alt' => 'Design editor placing text and shapes inside a property boundary'],
                    ['src' => 'lawnwriter/choose-property.webp', 'title' => 'Choose a Property', 'alt' => 'Choosing which property to create a design on'],
                    ['src' => 'lawnwriter/my-designs.webp', 'title' => 'My Designs', 'alt' => 'Saved design with route ready and a start mowing action'],
                    ['src' => 'lawnwriter/settings.webp', 'title' => 'Settings', 'alt' => 'Settings for units, map display, and navigation tracking'],
                ],
                'links' => [
                    ['title' => 'LawnWriter', 'url' => 'https://lawnwriter.com'],
                ],
                'technologies' => [
                    ['name' => 'React Native', 'icon_type' => 'simple-icons', 'icon_name' => 'react', 'is_highlighted' => true],
                    ['name' => 'Expo', 'icon_type' => 'simple-icons', 'icon_name' => 'expo', 'is_highlighted' => true],
                    ['name' => 'TypeScript', 'icon_type' => 'simple-icons', 'icon_name' => 'typescript', 'is_highlighted' => true],
                    ['name' => 'Laravel', 'icon_type' => 'simple-icons', 'icon_name' => 'laravel', 'is_highlighted' => true],
                    ['name' => 'PHP', 'icon_type' => 'simple-icons', 'icon_name' => 'php', 'is_highlighted' => true],
                    ['name' => 'MySQL', 'icon_type' => 'simple-icons', 'icon_name' => 'mysql', 'is_highlighted' => true],
                    ['name' => 'Google Maps API', 'icon_type' => 'simple-icons', 'icon_name' => 'googlemaps', 'is_highlighted' => true],
                    ['name' => 'REST APIs', 'is_highlighted' => true],
                    ['name' => 'Sanctum', 'icon_type' => 'simple-icons', 'icon_name' => 'laravel', 'is_highlighted' => false],
                    ['name' => 'Zustand', 'is_highlighted' => false],
                    ['name' => 'Firebase', 'icon_type' => 'simple-icons', 'icon_name' => 'firebase', 'is_highlighted' => false],
                    ['name' => 'Sentry', 'icon_type' => 'simple-icons', 'icon_name' => 'sentry', 'is_highlighted' => false],
                ],
                'tools' => [
                    ['name' => 'Expo EAS', 'icon_type' => 'simple-icons', 'icon_name' => 'expo'],
                    ['name' => 'App Store Connect', 'icon_type' => 'simple-icons', 'icon_name' => 'appstore'],
                    ['name' => 'RevenueCat', 'icon_type' => 'simple-icons', 'icon_name' => 'revenuecat'],
                    ['name' => 'Jest', 'icon_type' => 'simple-icons', 'icon_name' => 'jest'],
                    ['name' => 'Maestro'],
                    ['name' => 'PEST'],
                    ['name' => 'Github', 'icon_type' => 'simple-icons', 'icon_name' => 'github'],
                    ['name' => 'Composer', 'icon_type' => 'simple-icons', 'icon_name' => 'composer'],
                ],
                'awards' => [],
            ],
            ...
            [
                ...
                'technologies' => [
                    ['name' => 'Laravel', 'icon_type' => 'simple-icons', 'icon_name' => 'laravel', 'is_highlighted' => true],
                    ['name' => 'Vue.js', 'icon_type' => 'simple-icons', 'icon_name' => 'vuedotjs', 'is_highlighted' => false],
                    ['name' => 'PHP', 'icon_type' => 'simple-icons', 'icon_name' => 'php', 'is_highlighted' => true],
                    ['name' => 'MySQL', 'icon_type' => 'simple-icons', 'icon_name' => 'mysql', 'is_highlighted' => true],
                    ['name' => 'TypeScript', 'icon_type' => 'simple-icons', 'icon_name' => 'typescript', 'is_highlighted' => true],
                    ['name' => 'Vuex', 'icon_type' => 'simple-icons', 'icon_name' => 'vuedotjs', 'is_highlighted' => false],
                    ['name' => 'Pinia', 'is_highlighted' => false],
                    ['name' => 'REST APIs', 'is_highlighted' => true],
                    ['name' => 'Node.js', 'icon_type' => 'simple-icons', 'icon_name' => 'javascript', 'is_highlighted' => true],
                    ['name' => 'BootstrapVue', 'icon_type' => 'simple-icons', 'icon_name' => 'vuedotjs', 'is_highlighted' => false],
                ],
                'tools' => [
                    ['name' => 'Vite'],
                    ['name' => 'Bitbucket'],
            ...
            [
                ...
                'tools' => [
                    ...
                    ['name' => 'NPM'],
                    ['name' => 'Postman'],
                    ['name' => 'PHPUnit', 'icon_type' => 'simple-icons', 'icon_name' => 'php'],
                ],
                'awards' => [],
            ],
            ...
            [
                ...
                'technologies' => [
                    ...
                    ['name' => 'Active Directory', 'is_highlighted' => true],
                    ['name' => 'JWT', 'is_highlighted' => true],
                    ['name' => 'JavaScript', 'icon_type' => 'simple-icons', 'icon_name' => 'javascript', 'is_highlighted' => false],
                    ['name' => 'jQuery', 'is_highlighted' => false],
                    ['name' => 'Bootstrap', 'is_highlighted' => false],
                    ['name' => 'SCSS', 'icon_type' => 'simple-icons', 'icon_name' => 'css3', 'is_highlighted' => false],
            ...
            [
                ...
                'technologies' => [
                    ...
                    ['name' => 'PHP', 'icon_type' => 'simple-icons', 'icon_name' => 'php', 'is_highlighted' => true],
                    ['name' => 'MySQL', 'icon_type' => 'simple-icons', 'icon_name' => 'mysql', 'is_highlighted' => true],
                    ['name' => 'JavaScript', 'icon_type' => 'simple-icons', 'icon_name' => 'javascript', 'is_highlighted' => true],
                    ['name' => 'jQuery', 'is_highlighted' => true],
                    ['name' => 'Third-party APIs', 'is_highlighted' => true],
                    ['name' => 'Bootstrap', 'is_highlighted' => false],
                ],
