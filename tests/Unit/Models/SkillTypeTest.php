...
test('skill type has many skills', function () {
    ...
    Skill::create(['skill_type_id' => $skillType->id, 'name' => 'Laravel', 'order' => 0]);
    Skill::create(['skill_type_id' => $skillType->id, 'name' => 'PHP', 'order' => 1]);
...
test('skill type skills are ordered by order field', function () {
    $skillType = SkillType::create(['name' => 'Backend', 'slug' => 'backend', 'order' => 0]);
    Skill::create(['skill_type_id' => $skillType->id, 'name' => 'PHP', 'order' => 2]);
    Skill::create(['skill_type_id' => $skillType->id, 'name' => 'Laravel', 'order' => 0]);
    Skill::create(['skill_type_id' => $skillType->id, 'name' => 'MySQL', 'order' => 1]);
...
test('skill type with no skills returns empty collection', function () {
    $skillType = SkillType::create(['name' => 'Empty', 'slug' => 'empty', 'order' => 0]);
