...
test('skill belongs to skill type', function () {
    ...
    $skill = Skill::create(['skill_type_id' => $skillType->id, 'name' => 'Vue.js', 'order' => 0]);
...
test('skill belongs to icon', function () {
    ...
    $skillType = SkillType::create(['name' => 'Frontend', 'slug' => 'frontend', 'order' => 0]);
    $skill = Skill::create(['skill_type_id' => $skillType->id, 'name' => 'Vue.js', 'order' => 0, 'icon_id' => $icon->id]);
...
test('skill icon is null when no icon assigned', function () {
    $skillType = SkillType::create(['name' => 'Other', 'slug' => 'other', 'order' => 0]);
    $skill = Skill::create(['skill_type_id' => $skillType->id, 'name' => 'Misc', 'order' => 0]);
