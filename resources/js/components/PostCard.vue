...
<template>
    <li class="mb-12">
        <div
            class="group relative grid cursor-pointer grid-cols-8 gap-4 transition-all sm:items-center sm:gap-8 md:gap-4 lg:group-hover/list:opacity-50 lg:hover:opacity-100!"
